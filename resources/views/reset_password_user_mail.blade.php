                                ...
                                <tr><br>
                                 <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                  ...
                                  <p style="color:#455056; font-size:15px;line-height:24px; margin: 20px;justify-content: center;">
                                    ...
                                    If you’re having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser: <a href="{!!$url!!}" rel="noopener noreferrer">{!! $url !!}</a>
                                        </p>
                                    <!-- <td style="height:40px;">&nbsp;</td> -->
                                </tr>
                            </table>
