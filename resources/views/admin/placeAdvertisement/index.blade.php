                            ...
                            @php $i = 1; @endphp
                                @foreach($place_advertisement as $place_advertisement)
                                    <tr>
                                        ...
                                        <td id="{{$place_advertisement->id}}" ><span class="btn btn-block btn-success btn-sm status" data-id = "{{$place_advertisement->id}}" data-status = "{{$place_advertisement->status}}" onclick="updatestatus({{$place_advertisement->id}},{{$place_advertisement->status}})">Active</span></td><?php } else { ?>
                                    
                                        <td id="{{$place_advertisement->id}}" ><span class="btn btn-block btn-danger btn-sm status" data-id = "{{$place_advertisement->id}}" data-status = "{{$place_advertisement->status}}" onclick="updatestatus({{$place_advertisement->id}},{{$place_advertisement->status}})">Inactive</span></td><?php } ?>
