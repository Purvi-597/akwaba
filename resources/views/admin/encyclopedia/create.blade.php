...
@section('title')  Add Encyclopedia @endsection
@section('css')
<link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/libs/summernote/summernote.min.css')}}">
@endsection
@section('content')
@component('common-components.breadcrumb')
@slot('title') Add Encyclopedia @endslot
@endcomponent
<style>
.form-control{
...
<div class="row">
    <div class="col-12">
        ...
        @endif
            <form name="frm1" id="frm1" class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('encyclopedia.store')}}" novalidate>
                 @csrf
					
                    <div class="form-group">
                        <label for="formrow-quest_name-input">Story</label>
						<textarea id="elm1" name="story" class="form-control" aria-hidden="true" required></textarea>
