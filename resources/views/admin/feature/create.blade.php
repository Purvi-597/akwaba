    ...
    <div class="col-12">
        <div class="card mb-2">
           <div class="card-body">
            ...
            <form name="frm1" id="frm1" class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('feature.store')}}"  novalidate>
                 @csrf
     ...
     $("#images_0").val(null);
       $("#image_main0").attr('src','');
         $("#image_main0").css('display','none');
           ...
           $("#image0_error").text("Please upload images of following dimension width/height(371*104).");
           $("#image_main0").css("display", "none");
           $("#image_main0").attr('src','');
           $("#images_0").val("");
           }else{
           ...
           $('#image_main0').attr('src', img.src).height(104).width(371);
               }
           }
       };
