...
@section('title')  Add feature @endsection
@section('css')
    ...
    <div class="col-12">
        <div class="card mb-2">
           <div class="card-body">
            ...
            <form name="frm1" id="frm1" class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('feature.store')}}"  onclick="return CheckDimension()" novalidate>
                 @csrf
                    ...
                    <div class="form-group">
                        <label for="formrow-quest_name-input"> Rating</label>
						<input type="number" class="form-control" name="ratings" id="ratings" placeholder="Enter Description" value="{{old('ratings')}}" required>
                        <div class="invalid-feedback">
                            Please provide a Description.
                        </div>
                    </div>
