...
<div class="row">
    <div class="col-12">
        <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('feature.update',$feature->id)}}" novalidate>
            @csrf
        <div class="card mb-2">
            <div class="card-body">
                @if ($errors->any())
        ...
        @endif
             <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('feature.update',$feature->id)}}" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="description" id="description" placeholder="Enter  title" value="{{$feature->description}}" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ratings" id="ratings" placeholder="Enter  title" value="{{$feature->ratings}}" required>
                    <div class="invalid-feedback">
