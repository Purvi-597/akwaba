...
@section('title')  @lang('language.add_faq') @endsection
@section('css')
<link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/libs/summernote/summernote.min.css')}}">
@endsection
@section('content')
@component('common-components.breadcrumb')
@slot('title') @lang('language.add_faq') @endslot
@endcomponent
<style>
.form-control{
            ...
            <form name="frm1" id="frm1" class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('faq.store')}}"  onclick="return CheckDimension()" novalidate>
                 @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class=" form-control" name="answer" id="answer" placeholder="@lang('language.Answer_placeholder')" value="{{old('answer')}}" required>
                        <div class="invalid-feedback">
                            @lang('language.Answer_validation')
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="formrow-quest_name-input">@lang('language.FrAnswer')</label>
                        <input type="text" class="form-control" name="answer_fr" id="answer_fr" placeholder="@lang('language.frAnswer_placeholder')" value="{{old('answer_fr')}}"required ></textarea>
                        <div class="invalid-feedback">
                            @lang('language.frAnswer_validation')
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <a href="../faq" class="btn btn-danger">@lang('language.Cancel')</a>
                            </div>
                        </div>
                    </div>
                </form>
