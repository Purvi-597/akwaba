...
$tourismResult = pg_query($db, "select ST_AsGeoJSON(ST_Transform(way,4326)) as geoJSON_data,osm_id as osmid from planet_osm_point where tourism='attraction'");
$tourismData= [];
while($row = pg_fetch_row($tourismResult)) {
	$tourismID[] = array('id'=>$row[1]);
	array_push($tourismData, json_decode($row[0], true));
	
}

/* Aminity Parking fixed */
$parkingResult = pg_query($db, "select ST_AsGeoJSON(ST_Transform(way,4326)) as geoJSON_data,osm_id as osmid from planet_osm_point where amenity='parking'");
$parkingData= [];
while($row = pg_fetch_row($parkingResult)) {
	$parkingID[] = array('id'=>$row[1]);
    array_push($parkingData, json_decode($row[0], true));
}

/* Photos fixed */
$photos = "SELECT image, latitude, longtitude FROM `photos` WHERE `status` = '1' and deleted_at IS NULL";
...
if(isset($_SESSION['users'])){
	$cars = "SELECT * from make where 1=1";
      ...
      <div class="scrollbar left-scroll-2" data-simplebar>
        <div class="img-top img_top_user">
          ...
          <div class="d-lg-flex d-block d-md-flex img_top_username">
			...
			<a class="" href="javascript:void(0);">
                <div>
                  <p class="username"><img src="./uploads/users/<?= $_SESSION['users']['profile_pic'] ?>" alt="Profile picture"></p>
                </div>
              </a>
			<?php } ?>
            </div>
          ...
          <div class="tabmaindiv userdetails-tab" data-simplebar>
            <div class="tab-details">
              ...
              <ul class="nav nav-tabs" role="tablist" id="myTab">
                <li class="nav-item "><a href="#tab2" id="favoriteid" class="nav-link active" role="tab" data-toggle="tab">Favorites</a></li>
                <li class="nav-item "><a href="#tab4"  id="reviews" class="nav-link" role="tab" data-toggle="tab">Reviews</a></li>
                <li class="nav-item "><a href="#tab5" id="photos" class="nav-link" role="tab" data-toggle="tab">Photos</a></li>
                <li class="nav-item "><a href="#tab6" id="corrections" class="nav-link" role="tab" data-toggle="tab">Corrections</a></li>
              </ul>
                        ...
                        <div class="reviewHeadRating">
                          <div class="reviewHeadRatingDiv1">
                            <div class="reviewHeadRatingDiv12">
                              ...
                              max-width: 100%;
                              max-height: 100%;
                              background-image: url(./uploads/users/<?=$rev_res['profile_pic']?>);
...
<?php } ?>	
	  ...
	  <div class="scrollbar left-scroll-2" data-simplebar>
         <div class="img-top">
          <div class="input-group  search-bar">
            ...
            <input type="text" class="form-control searchData" id="search-box" placeholder="Search in Akwaba Maps">
			<div class="cross-btn">
              <button type="button" class="cross-btn2" aria-label="Clear local search field">
                <img src="./assets/img/icons/cross-search.svg" alt="">
              </button>
            </div>
		  </div>
      ...
      <div class="scrollbar featured-places" data-simplebar>
        <div class="img-top ">
         <div class="input-group  search-bar">
            ...
            <input type="text" class="form-control searchData" id="morecategory-search-box" placeholder="Search in Akwaba Maps">
			<div class="cross-btn">
              <button type="button" class="cross-btn2" aria-label="Clear local search field">
                <img src="./assets/img/icons/cross-search.svg" alt="">
              </button>
		  ...
		  <div id="morecategory-suggesstion-box"></div>
          <div class="img-top-name">
            <h4></h4>
            <p>Azerbaijan</p>
          </div>
      ...
      <div class="scrollbar featured-places">
        <div class="img-top ">
          <div class="input-group  search-bar">
            ...
            <input type="text" class="form-control searchData" id="feature-search-box" placeholder="Search in Akwaba Maps">
			<div class="cross-btn">
              <button type="button" class="cross-btn2" aria-label="Clear local search field">
                <img src="./assets/img/icons/cross-search.svg" alt="">
              </button>
		  ...
		  <div id="feature-suggesstion-box"></div>
          <div class="img-top-name">
            <h4><?=$title?></h4>
            <p><?=$description?></p>
          </div>
		...
		foreach($featureData as $frows) { ?>
		   <div class="row">
            <div class="col-md-12">
             <a href="javascript:void(0);" class="getFuturedlist" title="featured-places" id="<?= $frows['id'] ?>"> <img src="../uploads/featured/<?=$frows['image']?>" class="img-fluid" alt="<?=$frows['image']?>"></a>
            </div>
            ...
            <nav class="menu-details">
              <ul class="details-menu-list nav" role="tablist" id="myTab">
                <li class="menu-list">
                  ...
                  <div role="tab" data-toggle="tab" href="#tab2"  data-index="favorites"  class="menu-list-name tabBtn">Favorites</div>
                </li>
                <li class="menu-list">
                  <div class="menu-list-image">
                    <img src="assets/img/icons/ic_reviews.svg">
                  </div>
                  <div role="tab" data-toggle="tab" href="#tab4"  data-index="reviews" class="menu-list-name tabBtn">Reviews</div>
                </li>
                <li class="menu-list">
                  <div class="menu-list-image">
                    <img src="assets/img/icons/ic_photos.svg">
                  </div>
                  <div role="tab" data-toggle="tab" href="#tab5"  data-index="photos" class="menu-list-name tabBtn">Photos</div>
                </li>
                <li class="menu-list">
                  <div class="menu-list-image">
                    <img src="assets/img/icons/ic_corrections.svg">
                  </div>
                  <div role="tab" data-toggle="tab" href="#tab6"  data-index="corrections" class="menu-list-name tabBtn">Corrections</div>
                </li>
              </ul>
  ...
  <!-- Map Maker click detail Section-->
  <section class="mainbodysection">
    <div class="left-panel contect-list-panel tourismDiv" id="review-page" style="display: none;">
     </div>
  </section>
  
  <!-- Map Maker click detail Section-->
  <section class="mainbodysection">
    <div class="left-panel contect-list-panel parkingDiv" id="review-page" style="display: none;">
     </div>
  </section>
...
<script type="text/javascript">
		...
		var tourismID = JSON.parse('<?php echo json_encode($tourismID); ?>');
		var parkingID = JSON.parse('<?php echo json_encode($parkingID); ?>');
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-12 mt-3">
				...
				<input name="file_review[]" multiple type="file" id="uploadimgreview" class="review_photos" style="display: none;">
			  </div>
                </div>
              </div>
...
<div class="modal fade Edit-modal addcompany-modal" id="addcompanyModalCenter" tabindex="-1" role="dialog"
     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      ?>
			...
			<p style="margin-bottom: 0rem;margin-left: 7%;"><?=$_SESSION['users']['firstname'].' '.$_SESSION['users']['lastname']?></p>
          </div>
        <?php }?>
...
<!-- Photos Upload Modal -->
<div class="modal fade" id="photosModalCenter" tabindex="-1" role="dialog"
      aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
	  <form method="post" name="frm_photos" id="frm_photos"  enctype="multipart/form-data">
        <div class="modal-content">
          <div class="modal-header">
            <div class="d-lg-flex d-block d-md-flex align-items-lg-center">
              <img src="assets/img/left-brand-image.png" alt="..." class="user-profile-image-modal rounded-circle ">
              <div class="lh-1">
                <span class="code-deatils modal-deatils">Upload Photos</span>
              </div>
            </div>
          </div>
		  <div class="modal-body">
            <div class="row">
                ...
                <div class="imageslist">
                  <div class="lable-input singleimg">
				<label for="uploadimgreviews">
				  <img src="assets/img/left-brand-image.png"> 
				  <div class="overlaycount">
				  </div>
				</label>
				<input name="file_photos[]" multiple type="file" id="uploadimgreviews"  style="display: none;">
			  <h3 class="rating-stars"><span>(you can upload up to 5 photos)</span></h3>
			  </div>
                </div>
              </div>
            	<span id="photos_review_error" style="color:red;"></span>  
			  <div id="img_section4"></div>
            </div>
          </div>
		  
		  <input type="hidden" id="osm_ids" name="osmids" value=""/>
		  <input type="hidden" id="title" name="title" value=""/>
		  <?php if(isset($_SESSION['users'])) { ?>
				<input type="hidden" value="<?= $_SESSION['users']['id']?>" id="session_id" name="session_id" />
			<?php } ?>
          <div class="modal-footer review-footer-btn">
            <button type="button" class="btn btn-post savephotosBtn" >Upload</button>
            <button type="button" class="btn btn-cancel" data-dismiss="modal">Cancel</button>
          </div>
        </div>
	</form>	
...
$(document).ready(function() {
		...
		$(document).on('click','#morecategory-search-box', function(){
		  $.ajax({
				type: "POST",
				url: "allsearchdata_ajax.php",
				data: 'keyword=keyword',
				success: function(data) {
					console.log(data);
					$("#morecategory-suggesstion-box").show();
					$("#morecategory-suggesstion-box").html(data);
					$("#morecategory-search-box").css("background", "#FFF");
				}
			}); 
		});	
		$(document).on('click','#feature-search-box', function(){
		  $.ajax({
				type: "POST",
				url: "allsearchdata_ajax.php",
				data: 'keyword=keyword',
				success: function(data) {
					console.log(data);
					$("#feature-suggesstion-box").show();
					$("#feature-suggesstion-box").html(data);
					$("#feature-search-box").css("background", "#FFF");
				}
			}); 
		});	
...
<script>
 $(document).ready(function(){
  $(".form-control").click(function(){
    $(this).closest(".scrollbar").addClass('OnClickSearch');
  });
